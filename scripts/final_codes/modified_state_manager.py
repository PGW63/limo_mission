...
class StateManager:
    def __init__(self):
        ...
        self.mission_speeds = {
            ...
            State.DETECT_PEDESTRIAN: 0.3,      # 횡단보도 - 느리게
            State.ROTARY: 0.5,                 # 로터리
            State.OBSTACLE_AVOIDANCE: 0.3,   # 장애물 회피
            State.PARKING: 0.3,               # 주차 - 가장 느리게
        }
        self.default_speed = 0.5  # 기본 속도
    ...
    def _publish_mission_speed(self, state):
        ...
        # PEDESTRIAN 상태일 경우 일정 시간 후 정상 속도로 복귀
